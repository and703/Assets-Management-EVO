...
<li class="nav-item">
    <a href="<?php echo url('import') ?>" class="nav-link <?php echo (@$_page->menu=='assets_import')?'active':'' ?>">
      <i class="nav-icon fas fa-database"></i>
      <p>
        <?php echo lang('App.assets_import') ?>
      </p>
    </a>
  </li>
<li class="nav-item">
    <a href="<?php echo url('logs') ?>" class="nav-link <?php echo (@$_page->menu=='assets_api_logs')?'active':'' ?>">
      <i class="nav-icon fas fa-history"></i>
      <p>
        <?php echo lang('App.assets_api_logs') ?>
      </p>
    </a>
  </li>
