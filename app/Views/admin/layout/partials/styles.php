  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="<?php echo assets_url('admin') ?>/plugins/jqvmap/jqvmap.min.css">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?php echo assets_url('admin') ?>/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo assets_url('admin') ?>/plugins/daterangepicker/daterangepicker.css">
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo assets_url('admin') ?>/plugins/summernote/summernote-bs4.css">
  
  <!-- Select2 -->
  <link rel="stylesheet" href="<?php echo assets_url('admin') ?>/plugins/select2/css/select2.min.css" />

    <!-- Data Table Css -->
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url('admin') ?>/plugins/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url('admin') ?>/plugins/data-table/css/buttons.dataTables.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url('admin') ?>/plugins/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo assets_url('admin') ?>/plugins/data-table/extensions/buttons/css/buttons.dataTables.min.css">
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo assets_url('admin') ?>/css/app.css">
